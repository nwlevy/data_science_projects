...
pop_limits=[0,20,50,100,500,1000]
...
#write row headers
with open('pop_limit.csv','wt',newline='') as f:
    writer = csv.writer(f, delimiter=',')
    writer.writerow(['pop_limit','test_acc_1','test_acc_2','test_acc_3',
                         'test_f1_1','test_f1_2','test_f1_3','test_r2_1','test_r2_2','test_r2_3','overall_r2_1',
                         'overall_r2_2','overall_r2_3'])

    f.close()    

for i in range(0,len(pop_limits)):
    ...
    for j in range(0,len(X_trains)):
        ...
        regressor=RandomForestRegressor(max_depth=None,n_estimators=50, n_jobs=-1)
    ...
    with open('pop_limit.csv','at',newline='') as f:
        writer = csv.writer(f, delimiter=',')
        writer.writerow([pop_limits[i],classifier_accuracies[0],classifier_accuracies[1],classifier_accuracies[2],
